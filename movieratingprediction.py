...
Original file is located at
    https://colab.research.google.com/drive/1Kj_FrHYH3enYoI1whKHtSDRRxCt8bvpq
"""
...
plt.pie(top_n_genres['Count'], labels=top_n_genres['Genre'], autopct='%1.2f%%', startangle=140, colors=sns.color_palette('pastel'))
...
ax.set_title('Movies with rating greater than 8 and votes greater than 10000',fontsize=20)
plt.show()
